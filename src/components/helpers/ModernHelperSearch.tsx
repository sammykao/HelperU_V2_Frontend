        ...
        <div className="mb-8 backdrop-blur-lg bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-2xl p-6">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-white mb-2">Need Help Finding the Right Helpers?</h3>
              <p className="text-gray-300 text-sm mb-4">
                Our AI Assistant can help you craft better search queries, suggest optimal filters, 
                and provide tips for finding qualified helpers. Get personalized recommendations 
                to improve your search results and connect with the best student helpers for your tasks.
              </p>
              <button
