    ...
    <div className="w-full h-full flex flex-col items-start justify-between p-1 gap-y-2">
      <div className="h-48 bg-linear-to-bl from-fuchsia-500 via-pink-400 to-purple-600 w-full rounded-2xl flex flex-row justify-between items-center px-2 py-2">
        <div className="bg-white rounded-full p-1">
          <img src={url} className="size-32 rounded-full shrink-0" />
        </div>
        <div className="text-white mr-3 text-left tracking-tight space-y-2">
      ...
      <div className="w-full h-full flex flex-col items-start justify-center gap-y-2  rounded-md px-2 py-4">
        <span className="tracking-tight font-bold text-3xl">Social Media Manager</span>
        <span className="whitespace-pre-wrap text-left tracking-tight">
      ...
      <div className="w-full h-fit bg-linear-to-br text-white from-fuchsia-500 via-pink-400 to-purple-600 rounded-md py-2 mb-1">Find Helpers</div>
    </div>
  )
}
