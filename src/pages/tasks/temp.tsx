...
{/* Search and Filters */ }
<div className={`bg-white border border-gray-200 rounded-2xl shadow-sm mb-6 sm:mb-8 transition-all duration-500 ease-in-out ${showFilters ? 'p-4 sm:p-6 opacity-100 max-h-screen' : 'sm:p-6 p-0 opacity-0 max-h-0 sm:opacity-100 sm:max-h-screen overflow-hidden'
  }`}>
  <div className="mb-4">
