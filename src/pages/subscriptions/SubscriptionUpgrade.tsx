            ...
            <div className="text-center">
              ...
              {subscriptionStatus.plan !== 'free' && (
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-800 hover:from-red-700 hover:to-red-800 text-white rounded-lg transition-all duration-200 flex items-center text-sm font-medium mx-auto"
                >
