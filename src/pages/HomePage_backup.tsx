...
import HeroIcon from "@/components/svgIcons/HeroIcon"


// {/* floating CTA */}
// <div className='absolute bottom-20 left-10 bg-gradient-to-tl from-cyan-400 to-sky-600 rounded-full h-fit w-fit py-2 px-6'>
//   <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
//     <Link
//       to="/auth/client"
//       className="w-full sm:w-auto px-2 sm:px-4 py-1 sm:py-4 border-slate-50 hover:bg-gradient-to-tl hover:from-cyan-500 hover:to-blue-700 border text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow hover:shadow-blue-500/20 font-display text-center text-sm"
//     >
//       Post for free
//     </Link>
//     <Link
//       to="/auth/helper"
//       className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-blue-50 text-blue-700 font-semibold rounded-xl border border-blue-200 hover:bg-blue-100 transition-all duration-300 font-display text-center hover:scale-105 text-sm"
//     >
//       Start earning money
//     </Link>
//   </div>
...
const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-linear-to-br from-white via-blue-50 to-blue-100 overflow-hidden">
      <Navbar />

      {/* Hero Section */}
      <section className="z-10 h-screen w-full grid grid-rows-[0.25fr_1fr] lg:grid-cols-[2fr_1fr] items-center justify-center px-10 relative ">

        {/* Left side: Text content */}
        <div className="order-2 lg:order-1 flex justify-center items-center w-full h-full ">
          <div className="grid grid-rows-[auto_auto_1fr] gap-6 items-center justify-center text-center">
            {/* Main Heading */}
            <h1 className="text-2xl sm:text-4xl md:text-6xl font-display font-black text-gray-900 leading-tight w-full">
              The future of reaching college students
            </h1>
            {/* Subtitles */}
            <p className="text-sm sm:text-lg md:text-2xl text-gray-600 max-w-xl sm:max-w-2xl mx-auto leading-relaxed font-medium">
              Connecting clients with needs to verified helpers, creating win-win situations for all
            </p>
