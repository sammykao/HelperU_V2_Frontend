      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Browse Posts</h3>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Chats</h3>
          ...
          >
            ...
            <p className="text-gray-300 text-sm">Update your profile information and skills</p>
          </div>
        </div>
        ...
        <div className="mt-8 backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl p-6">
          ...
          <p className="text-gray-300 mb-4">
            Get help with finding opportunities, applying to posts, or answering questions about HelperU. The AI assistant can help you with anything you need.
          </p>
          <button 
